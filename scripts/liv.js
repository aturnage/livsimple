...
function load_home() {
     document.querySelector(".hop").innerHTML='<object type="text/html" data="header.html" ></object>';
}
...
function load_home() {
     document.query("hop").innerHTML='<object type="text/html" data="header.html" ></object>';
}
